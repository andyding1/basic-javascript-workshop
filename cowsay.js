...
var quotesArray = [quote1,quote2,quote3,quote4,quote5,quote6,quote7,quote8,quote9,quote10]

function randomQuote() {
    var quoteToUse = quotesArray[Math.floor(Math.random()*quotesArray.length)];
    return quoteToUse;
}
